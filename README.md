...
*   This app is made to work for android 7+ (api version 24+) devices, although its recomended to use the newest version because thats where it's tested the best.
*   Tablets and foldables, as well as horizontal mode are **not** curently officialy supported, it will work but will not look as intended, nor will it take advantage of the form factor.
